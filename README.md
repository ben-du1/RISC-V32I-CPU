...
## Memory
The CPU has 8 KB of memory with the first 4 KB reserved for the bootloader by default. Natively, our memory array is 32 bit x 1024 and word-addressed to allow for proper BSRAM inference but it is regarded as byte-addressable during reads and writes through splicing and reassembly.

| Address Range             |   Size | Purpose                                       |
| ------------------------- | -----: | --------------------------------------------- |
| `0x00000000 – 0x00000FFF` |   4 KB | Bootloader               |
| `0x00001000 – 0x00002000` |   4 KB | Program Memory & Stack  |
